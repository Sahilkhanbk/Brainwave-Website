...
import Genrating from "./Genrating.jsx";
import {
  PhotChatMessage,
  VideoBar,
  VideoChatMessage,
    ...
    <Section id="how-to-use">
      <div className="conainer">
        <Heading
          ...
          text="Brainwave unlocked the potential of AI-powered applications"
        />
        <div className="relative">
          ...
          >
            ...
            <Genrating
              className="absolute bottom-4 left-4 right-4 border-n-1/10 border lg:left-1/2 
